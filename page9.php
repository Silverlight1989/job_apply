...
<h1>Типичное Питерское</h1>

<p>Над Невой свели мосты,</p> 
<p>Я спешу к тебе на встречу,</p> 
<p>Чтобы в этот тихий вечер</p> 
<p>В них не затерялась ты</p>
<br>
<p>Растопи теплом снега,</p> 
<p>Чтобы дать воде свободу,</p> 
<p>Ей в любое время года</p> 
<p>Та свобода дорога.</p> 
<br>
<p>Озари звездою ночь,</p> 
<p>Чтоб она Светлее стала...</p> 
<p>Года нового начало</p> 
<p>Зажигается точь-в-точь</p>
...
<?php
  $page_id = 9;// Уникальный идентификатор страницы (статьи или поста)
